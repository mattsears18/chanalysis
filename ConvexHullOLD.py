        ...
        for participantNum in participantNums:     
            ...
            for dwg in dwgs:
                ...
                if(len(data.index) > 10):
                    ...
                    # Calculate time steps and durations
                    ...
                    for row in range(len(times) - 1, -1, -1):
                        ...
                        if(startRow):
                            ...
                            duration = data.iloc[row,:]['totaltime'] - data.iloc[row - 1,:]['totaltime']
                            data.set_value(row, 'duration', duration)
                    ...
                    # Split data into parts by partThresh
                            
                    partNum = 1
                    
                    # Assign part numbers
                    for row in range(firstRow, len(times)):
                        if data.iloc[row]['duration'] > partThresh:
                            partNum += 1
                        
                        data.set_value(row, 'part', partNum)
                    ...
                    for i in range(1, totalParts + 1):
                        ...
                        #### filter out the high values here before appending to parts[]
                        ##also, remove rows before firstRow for part 1
                        ...
                        parts.append(data[data['part'] == i])
                    
                    # for each part in parts do the rest...
                    for part in parts:
                        partNum = int(part.iloc[0]['part'])
                        ...
                        def update(frame):     
                            ...
                            if(not np.isnan(row['startRow'])):
                                plotPoints = part[int(row['startRow']):frame+1]
