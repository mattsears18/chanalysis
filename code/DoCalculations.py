...
periods = [10000]  # Time periods (in ms) to calculate convex hull areas
participantNums = range(1, 21)
dwgs = range(1, 11)

partThresh = 10000  # DWG Viewing Time Threshold (ms)
partPointMin = 100  # Minimum # of points required to make a part
