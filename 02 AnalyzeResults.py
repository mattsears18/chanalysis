...
# Make a viewing duration distribution histogram
x = results['viewingTime']
...
vt = results['viewingTime']

print('Range: ' + str(np.amin(vt)) + ' - ' + str(np.amax(pt)) + 's')
print('Median: ' + str(np.median(vt)) + 's')
print('Mean: ' + str(np.mean(vt)) + 's')
print('%.2f' % stats.percentileofscore(vt, 50) + '% of viewings had a duration less than 50s')